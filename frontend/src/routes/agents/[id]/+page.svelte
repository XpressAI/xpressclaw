...
<div class="flex flex-col h-full">
	<!-- Sticky header -->
	<div class="sticky top-0 z-10 bg-background border-b border-border px-6 py-4 space-y-3">
	...
	<!-- Scrollable body -->
	<div class="flex-1 overflow-y-auto px-6 py-6 space-y-6 pb-24">
		{#if agent}
	...
	<!-- Floating save bar -->
	{#if agent}
		<div class="sticky bottom-0 z-10 border-t border-border bg-background px-6 py-3 flex items-center gap-3">
